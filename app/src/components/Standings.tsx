    ...
    <div className="standings">
      <div className="standings-row header">
        ...
        <div className="value points">
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip id="tt_points">Punten</Tooltip>}
          >
            <span>P</span>
          </OverlayTrigger>
        </div>
        <div className="value">
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip id="tt_played">Gespeeld</Tooltip>}
          >
            <span>GS</span>
          </OverlayTrigger>
        </div>
        <div className="value hide-sm">
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip id="tt_wins">Winst</Tooltip>}
          >
            <span>W</span>
          </OverlayTrigger>
        </div>
        <div className="value hide-sm">
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip id="tt_equal">Gelijk</Tooltip>}
          >
            <span>G</span>
          </OverlayTrigger>
        </div>
        <div className="value hide-sm">
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip id="tt_lost">Verloren</Tooltip>}
          >
            <span>V</span>
          </OverlayTrigger>
        </div>
        ...
        <div className="value">
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip id="tt_goals_diff">Doelsaldo</Tooltip>}
          >
            <span>DS</span>
          </OverlayTrigger>
        </div>
      ...
      {[...scores]
        ...
        .map((teamScore, index) => {
          ...
          const classes = cn('standings-row', {
