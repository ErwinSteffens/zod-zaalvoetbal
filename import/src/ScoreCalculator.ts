...
class ScoreCalculator {
  ...
  private processGame(game: Game) {
    ...
    this.processScore(game.pouleId, game.homeTeamId, game.homeScore, game.awayScore, game.status)
    this.processScore(game.pouleId, game.awayTeamId, game.awayScore, game.homeScore, game.status)
  }
